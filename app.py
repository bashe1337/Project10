...
BACKEND_URL = "https://project10-h0h1.onrender.com/convert"

st.set_page_config(page_title=" Тут координаты конвертируются бам бам", layout="centered")

# Заголовок и описание
st.title(" Конвертировать координаты")
